...
const UserProfilePage = () => {
  ...
  if (!isAuthenticated) {
    ...
    // You might want to pass the intended destination via state to redirect back after login
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <div className="mb-6">
                ...
                <p className="mt-1 text-sm text-gray-700 dark:text-gray-300">{user.id || 'N/A'}</p>
              </div>
              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-500 dark:text-gray-400">Role</label>
                <p className="mt-1 text-sm capitalize text-gray-700 dark:text-gray-300">{user.role || 'User'}</p>
              </div>
              {/* Add more profile fields or actions here later */}
              <div className="mt-8">

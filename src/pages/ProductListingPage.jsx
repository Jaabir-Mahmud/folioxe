...
const ProductListingPage = () => {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [selectedCategory, sortOption, products.length]);
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      className={`px-3 py-1 rounded-l border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 ${currentPage === 1 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-100 dark:hover:bg-gray-800'}`}
      >
      Prev
      </button>
      ...
      className={`px-3 py-1 border-t border-b border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 ${page === currentPage ? 'font-bold bg-gray-200 dark:bg-gray-800' : 'hover:bg-gray-100 dark:hover:bg-gray-800'}`}
      >
      {page}
      </button>
      ))}
      ...
      className={`px-3 py-1 rounded-r border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 ${currentPage === totalPages ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-100 dark:hover:bg-gray-800'}`}
      >
      Next
      </button>
      </nav>

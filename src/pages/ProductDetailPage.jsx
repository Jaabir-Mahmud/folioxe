      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-start">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            {product.mainFileUrl && (
              <a 
                href={product.mainFileUrl} 
                download={product.mainFileName || 'download'}
                className="w-full sm:w-auto bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white font-bold py-3 px-6 rounded-lg shadow-md transition duration-300 ease-in-out text-center inline-flex items-center justify-center"
              >
